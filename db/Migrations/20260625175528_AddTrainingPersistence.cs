...
namespace Unified.Db.Migrations
{
    ...
    public partial class AddTrainingPersistence : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AwardedOn = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    ...
                    NoticeState = table.Column<string>(
                        type: "character varying(50)",
                        maxLength: 50,
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "UserTrainings");

            migrationBuilder.DropTable(name: "Trainings");

            migrationBuilder.DropTable(name: "TrainingCategories");
        }
    }
}
