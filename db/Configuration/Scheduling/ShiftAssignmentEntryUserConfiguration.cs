...
public class ShiftAssignmentEntryUserConfiguration : BaseEntityConfiguration<ShiftAssignmentEntryUser>
{
    public override void Configure(EntityTypeBuilder<ShiftAssignmentEntryUser> builder)
    {
        ...
        builder.HasOne(b => b.User).WithMany().HasForeignKey(b => b.UserId).OnDelete(DeleteBehavior.Restrict);
