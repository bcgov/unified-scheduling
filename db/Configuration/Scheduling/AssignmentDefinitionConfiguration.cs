    ...
    : BaseEntityConfiguration<AssignmentDefinition>
{
    public override void Configure(EntityTypeBuilder<AssignmentDefinition> builder)
    {
        ...
        builder
            .HasOne(x => x.AssignmentCategoryType)
            .WithMany()
            .HasForeignKey(x => x.AssignmentCategoryTypeId)
            .OnDelete(DeleteBehavior.Restrict);
        builder
            .HasOne(x => x.AssignmentSubCategoryType)
            .WithMany()
            .HasForeignKey(x => x.AssignmentSubCategoryTypeId)
            .OnDelete(DeleteBehavior.Restrict);
        builder.ToTable(
