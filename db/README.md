...
2. Create a migration:
   ...
   ```bash
   docker compose exec api bash -lc "dotnet ef migrations add AddUserAwayLocationsTable --project db --startup-project api/Unified.Api --context UnifiedDbContext"
   ```
