...
erDiagram
    ...
    StatCategory {
        int     Id            PK  "GENERATED BY DEFAULT AS IDENTITY (start 200)"
        int     GroupId       FK
        string  Name              "e.g. Court Security, Transports Air"
...
| `Name` | `text` | No | — | e.g. *Court Security*, *Transports Air - Hours-Trips* |
...
| Transports Air (NS + SUP) | Level 1/2/3 Staff + Overtime Hours, Level 1/2/3 Trips, Level 1/2/3 Air counts |
| Transports Ground (NS + SUP) | Level 1/2/3 Staff + Overtime Hours, Trips, Level 1/2/3 Ground counts + km |
| Transports Females / Males | Staff Hours, Overtime Hours, Custodies – Regulars, Custodies – SEG/PC/MH |
