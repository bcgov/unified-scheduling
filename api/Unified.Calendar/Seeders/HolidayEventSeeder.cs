        ...
        for (var index = 0; index < seedDocument.Holidays.Count; index++)
        {
            ...
            var existingEvent = await dbContext.Events.FirstOrDefaultAsync(
                eventEntity =>
                    ...
                    && eventEntity.EventTypeCode == CalendarCodeMappings.ToDbCode(CalendarEventTypeCode.Holiday)
            ...
            existingEvent.EventTypeCode = CalendarCodeMappings.ToDbCode(CalendarEventTypeCode.Holiday);
            existingEvent.StatusTypeCode = CalendarCodeMappings.ToDbCode(CalendarEventStatusTypeCode.Active);
