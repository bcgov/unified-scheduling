...
public sealed class AssignmentController(
    ...
    AssignmentEntryUpdateRequestValidator assignmentEntryUpdateRequestValidator
) : ControllerBase
{
    [HttpGet("series")]
    ...
    [Authorize(Policy = SchedulingPolicies.AssignmentsDelete)]
    public async Task<IActionResult> DeleteAssignmentSeries(int id, CancellationToken cancellationToken) =>
        await assignmentService.DeleteAssignmentSeriesAsync(id, cancellationToken) ? NoContent() : NotFound();
    ...
    public async Task<ActionResult<AssignmentEntryResponse>> UpdateAssignmentEntry(
        int id,
        [FromBody] AssignmentEntryUpdateRequest request,
        CancellationToken cancellationToken
    )
    {
    ...
    [Authorize(Policy = SchedulingPolicies.AssignmentsDelete)]
    public async Task<IActionResult> DeleteAssignmentEntry(int id, CancellationToken cancellationToken) =>
        await assignmentService.DeleteAssignmentEntryAsync(id, cancellationToken) ? NoContent() : NotFound();
