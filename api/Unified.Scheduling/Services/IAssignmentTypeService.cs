...
{
    Task<IReadOnlyCollection<AssignmentTypeResponse>> GetAssignmentTypesAsync(CancellationToken cancellationToken = default);

    Task<AssignmentTypeResponse?> GetAssignmentTypeByIdAsync(int id, CancellationToken cancellationToken = default);

    Task<AssignmentTypeResponse?> GetAssignmentTypeByCodeAsync(string code, CancellationToken cancellationToken = default);
