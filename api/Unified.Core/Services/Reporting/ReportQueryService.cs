...
public sealed class ReportQueryService(
    IEnumerable<IReportQueryHandler> handlers,
    ILogger<ReportQueryService> logger
) : IReportQueryService
{
    private const int MaxPageSize = 500;

    private readonly Dictionary<string, IReportQueryHandler> _handlers = handlers
    ...
    public Task<ReportQueryResult> ExecuteAsync(
        string reportKey,
