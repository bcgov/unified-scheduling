    ...
    public async Task HolidayEventSeeder_SeedAsync_CreatesNewEventsUpdatesExistingEventsAndSkipsInvalidRows()
    {
        ...
        _dbContext.Events.Add(
            new Event
            {
                ...
                StatusTypeCode = CalendarCodeMappings.ToDbCode(CalendarEventStatusTypeCode.Cancelled),
        ...
        try
        {
            ...
            Assert.Equal(CalendarCodeMappings.ToDbCode(CalendarEventTypeCode.Holiday), existing.EventTypeCode);
            Assert.Equal(CalendarCodeMappings.ToDbCode(CalendarEventStatusTypeCode.Active), existing.StatusTypeCode);
