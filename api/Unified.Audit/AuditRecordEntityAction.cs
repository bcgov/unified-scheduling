...
/// </summary>
public sealed class AuditRecordEntityAction(
...
)
{
    ...
    public bool Populate(AuditEvent auditEvent, EventEntry entry, AuditRecord record)
    {
        ...
        record.CorrelationId = ResolveCorrelationId(auditEvent);
    ...
    private string? ResolveCorrelationId(AuditEvent auditEvent)
    {
        ...
        foreach (var headerName in options.CorrelationIdHeaderNames)
        {
