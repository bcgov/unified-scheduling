...
public static class AuditModule
{
    ...
    public static IServiceProvider UseAuditModule(this IServiceProvider services)
    {
        ...
        var entityAction = new AuditRecordEntityAction(new HttpContextActorResolver(httpContextAccessor), httpContextAccessor, options);

        // Populates AuditEvent.Activity from the ambient System.Diagnostics.Activity, giving
        // AuditRecordEntityAction a correlation id fallback for non-HTTP contexts (e.g. Hangfire jobs).
