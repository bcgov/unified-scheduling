...
Issue #130 records the decision that application authorization checks
permissions rather than roles, avoiding role-permission combinations that
...
- Document any approved exceptions for direct role inspection.
