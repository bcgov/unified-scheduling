...
import { buildDiffRows, formatKeyValues, formatOccurredOn } from '../utils/auditFormat';
...
const headers = [
  ...
  { title: 'Entity Key', key: 'keyValues', sortable: false },
    ...
    <div class="audit-layout">
      <div class="panel">
        ...
        >
          ...
          <template #[`item.keyValues`]="{ item }">
            {{ formatKeyValues(item.keyValues) }}
          </template>
