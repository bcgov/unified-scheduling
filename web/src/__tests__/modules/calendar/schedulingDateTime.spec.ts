...
describe('schedulingDateTime', () => {
  ...
  it('converts a scheduling calendar day to an exclusive UTC range', () => {
    expect(toUtcCalendarDayRange('2026-09-09', 'America/Vancouver')).toEqual({
      startAtUtc: '2026-09-09T07:00:00Z',
      endAtUtc: '2026-09-10T07:00:00Z',
    });
    expect(toUtcCalendarDayRange('', 'America/Vancouver')).toBeNull();
  });
